                           ...
                           <table class="table" >
                               <thead id="tasks-list" name="tasks-list">
                                   ...
                                   <tr>
                                       <td>Belge NO:</td>
                                       <td> 
                                           {{$firma->kalite_belgeleri()->first()->pivot->belge_no}}
                                       </td>
                                   </tr>
                                   </tr>
                               </thead>
                       ...
                       <table class="table" >
                           <thead id="tasks-list" name="tasks-list">
                               ...
                               <tr>
                                   ...
                                   <td>{{$firma->firma_calisma_bilgileri->calisma_gunleri->adi}}</td>
                               </tr>
                               <tr>
                           ...
                           <div class="modal-dialog">
                               <div class="modal-content">
                                   ...
                                   <div class="modal-body">
                                       ...
                                       <div class="form-group">
                                           <label for="inputEmail3" class="col-sm-3 control-label">Çalışan Günleri</label>
                                           <div class="col-sm-9">
